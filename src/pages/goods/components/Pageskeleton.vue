<template name="skeleton">
  <view class="sk-container">
    <scroll-view scroll-y class="viewport viewport" enable-back-to-top>
      <view class="goods goods">
        <view class="preview preview">
          <swiper circular :current="0" autoplay>
            <swiper-item
              style="
                position: absolute;
                width: 100%;
        ...
        <view class="meta meta">
          <view class="price price">
            ...
            <text class="number sk-transparent sk-text-14-2857-522 sk-text">39.00</text>
          </view>
          <view class="name ellipsis sk-transparent sk-text-14-2857-948 sk-text"
            >浓缩的精华，宠物化毛营养膏120克/支</view
          >
          <view class="desc sk-transparent sk-text-0-0000-234 sk-text"
            >温和化毛，补充营养，二合一app</view
          >
        </view>
        <view class="action action">
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-837 sk-text">选择</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-866 sk-text">
              请选择商品规格
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-712 sk-text">送至</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-895 sk-text">
              请选择收获地址
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-287 sk-text">服务</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-141 sk-text">
              无忧退 快速退款 免费包邮
            </text>
          </view>
        </view>
      ...
      <view class="detail detail panel panel">
        <view class="title title">
          <text class="sk-transparent sk-text-0-0000-881 sk-text">详情</text>
        </view>
        <view class="content content">
          <view class="properties properties">
            <view class="item item">
              <text class="label sk-transparent sk-text-25-0000-626 sk-text">品名</text>
              <text class="value sk-transparent sk-text-25-0000-752 sk-text">宠物营养补充剂</text>
            </view>
          </view>
        </view>
      </view>
    ...
    <view class="toolbar toolbar" style="padding-bottom: 34px">
      ...
      <view class="buttons buttons">
        <view
          class="addcart sk-transparent sk-text-32-9268-948 sk-text"
          style="background-position-x: 50%"
        >
          加入购物车
        </view>
        <view
          class="buynow sk-transparent sk-text-32-9268-644 sk-text"
          style="background-position-x: 50%"
        >
          立即购买
        </view>
