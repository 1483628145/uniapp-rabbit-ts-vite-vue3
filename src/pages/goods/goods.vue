...
<template>
  ...
  <scroll-view v-else scroll-y class="viewport">
    ...
    <view class="similar panel">
      ...
      <view class="content">
        <navigator
          v-for="similarPro in goodsDetail.similarProducts"
          :key="similarPro.id"
          class="goods"
          hover-class="none"
          :url="`/pages/goods/goods?id=`"
        >
          <image class="image" mode="aspectFill" :src="similarPro.picture"></image>
          <view class="name ellipsis">{{ similarPro.name }}</view>
          <view class="price">
            <text class="symbol">¥</text>
            <text class="number">{{ similarPro.price }}</text>
          </view>
        </navigator>
      </view>
    </view>
